...
/**
 * Jam topbar mengikuti zona pilihan pengguna, bukan jam perangkat.
 *
 * Offsetnya dihitung sendiri dari waktu UTC — Bos memilih tiga label ini, bukan
 * zona kota IANA, jadi `Intl` dengan nama zona sengaja tidak dipakai.
 */
...
/** Zona pilihan pengguna; nilai kosong atau asing jatuh ke zona bawaan. */
...
export function waktuZona(saat: Date, zona: ZonaWaktu): WaktuTampil {
  ...
  // Digeser di atas nilai UTC lalu dibaca lewat getUTC* — hasilnya sama di
  // perangkat mana pun, sekalipun jam perangkatnya salah zona.
